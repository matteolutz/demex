...
impl Action {
    pub fn run(
        ...
        match self {
            ...
            Self::SetColor(fixture_selector, rgbw) => {
                self.run_set_color(preset_handler, fixture_handler, fixture_selector, *rgbw)
            }
            ...
            Self::SetPosition(fixture_selector, position) => {
                self.run_set_position(preset_handler, fixture_handler, fixture_selector, *position)
            }
            Self::GoHome(fixture_selector) => {
                self.run_go_home(preset_handler, fixture_handler, fixture_selector)
            }
            ...
            Self::RecordGroup(fixture_selector, id) => {
                self.run_record_group(fixture_selector, *id, preset_handler)
            }
            ...
            Self::RecordColor(fixture_selector, id) => {
                self.run_record_color(fixture_selector, *id, preset_handler, fixture_handler)
            }
            Self::RecordPosition(fixture_selector, id) => {
                self.run_record_position(fixture_selector, *id, preset_handler, fixture_handler)
            }
    ...
    fn run_record_group(
        ...
        preset_handler
            .record_group(fixture_selector.clone(), id)
            .map_err(ActionRunError::PresetHandlerError)?;
    ...
    fn run_record_color(
        ...
        preset_handler
            .record_color(fixture_selector, id, fixture_handler)
            .map_err(ActionRunError::PresetHandlerError)?;
    ...
    fn run_record_position(
        ...
        preset_handler
            .record_position(fixture_selector, id, fixture_handler)
            .map_err(ActionRunError::PresetHandlerError)?;
