...
impl LayoutProjection {
    pub fn reset(&mut self) {
        self.zoom = 1.0;
        self.center = emath::Vec2::default();
    }
    ...
    pub fn center_mut(&mut self) -> &mut emath::Vec2 {
        &mut self.center
    }
}
...
impl LayoutProjection {
    ...
    pub fn project(&self, world_pos: &emath::Pos2, screen: &egui::Rect) -> emath::Pos2 {
    ...
    pub fn unproject(&self, screen_pos: &emath::Pos2, screen: &egui::Rect) -> emath::Pos2 {
    ...
    pub fn scale(&self, vec: &emath::Vec2) -> emath::Vec2 {
        *vec * self.zoom
    }

    pub fn scale_ref(&self, vec: &mut emath::Vec2) {
        vec.x *= self.zoom;
        vec.y *= self.zoom;
    }
}
...
mod tests {
    ...
    pub fn test_projection_basic() {
        ...
        let screen = Rect::from_min_max(emath::pos2(10.0, 10.0), emath::pos2(20.0, 20.0));

        let orig_point = emath::pos2(-1.0, 0.0);

        let screen_point = projection.project(&orig_point, &screen);
        assert_eq!(screen_point, emath::pos2(13.0, 15.0));
...
pub fn draw_center_of_mass(
    ...
    let rect = egui::Rect::from_center_size(center, emath::vec2(radius, radius));
