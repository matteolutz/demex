...
impl Token {
    pub fn token_type(&self) -> TokenType {
        match self {
            ...
            Token::KeywordGlobal => TokenType::ValueKeyword,
            ...
            Token::KeywordMove => TokenType::ActionKeyword,
            ...
            Token::KeywordHighlight => TokenType::ActionKeyword,
            Token::KeywordUnhighlight => TokenType::ActionKeyword,
...
impl std::fmt::Display for Token {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Token::KeywordMove => write!(f, "move"),
            ...
            Token::KeywordUnassign => write!(f, "unassign"),
